...
function () {
  function Customizator() {
    ...
    this.scale = localStorage.getItem('scale') || 1; //или по умолчанию установится 1

    this.color = localStorage.getItem('color') || '#ffffff'; // или по умолчанию установится белый цвет
  ...
  _createClass(Customizator, [{
    ...
    value: function onScaleChange(e) {
      ...
      if (e) {
        this.scale = +e.target.value.replace(/x/g, ""); // рег выражение, находит все х глобально и меняет их на пустую строку  
      }
        ...
        element.childNodes.forEach(function (node) {
          if (node.nodeName === '#text' && node.nodeValue.replace(/\s+/g, "").length > 0) {
            if (!node.parentNode.getAttribute('data-fz')) {
              var value = window.getComputedStyle(node.parentNode, null).fontSize; // узнаем какие стили применены к род элем и выбираем нужный нам
    ...
    value: function reset() {
      localStorage.clear(); // метод для очищения данных в лок хранилище
